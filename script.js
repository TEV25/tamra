...
// ========== منتجات السخانات (34 صنفاً) ==========
const sakhanatProducts = [
    { id: 1, name: "حنيني", type: "sakhanat", category: "سخانات", mainImage: "images/حنيني.png", images: ["images/حنيني.png"], description: "" },
...
// ========== منتجات تجهيزات المناسبات (6 أصناف – جاهزة لاستقبال صورك) ==========
const eventsProducts = [
    { id: 301, name: "كراسي فاخرة - 24 كرسي", type: "events", category: "تأجير", mainImage: "images/chairs1.jpg", images: ["images/chairs1.jpg", "images/chairs2.jpg"], description: "كراسي ذهبية فاخرة عدد 24 كرسي، مناسبة للأفراح والعزاء. لون ذهبي مع وسادة حمراء. (يمكنك إضافة صور متعددة لاحقاً)" },
